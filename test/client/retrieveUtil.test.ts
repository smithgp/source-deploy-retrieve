...
describe('Tooling Retrieve Util', () => {
  ...
  describe('buildQuery', () => {
    ...
    it('should generate correct query to retrieve an ApexPage', () => {
      ...
      expect(queryString).to.equal(
        `Select Id, Name, NamespacePrefix, Markup, Metadata from ApexPage where Name = 'myPage' and NamespacePrefix = ''`
      );
    });

    it('should generate correct query to retrieve an AuraDefinition', () => {
      const queryString = buildQuery(auraMDComponent, '');
      let expectedQuery = 'Select Id, AuraDefinitionBundle.DeveloperName, ';
      expectedQuery +=
        'AuraDefinitionBundle.NamespacePrefix, DefType, Source, AuraDefinitionBundle.Metadata ';
  ...
  describe('queryToFileMap', () => {
    ...
    it('should generate correct file map for ApexPage metadata', () => {
      ...
      expectedMetaXML += '    <availableInTouch>true</availableInTouch>\n';
      expectedMetaXML += '    <confirmationTokenRequired>false</confirmationTokenRequired>\n';
      expectedMetaXML += '    <description>A description</description>\n';
      expectedMetaXML += '    <label>MyPage</label>\n';
    ...
    it('should generate correct file map for AuraDefinition component metadata', () => {
      ...
      expectedMetaXML += '    <description>A bundle</description>\n';
      expectedMetaXML += '    <type>Component</type>\n';
    ...
    it('should generate correct file map for AuraDefinition application metadata', () => {
      ...
      expectedMetaXML += '    <apiVersion>48.0</apiVersion>\n';
      expectedMetaXML += '    <description>A bundle</description>\n';
      expectedMetaXML += '    <type>Application</type>\n';
      expectedMetaXML += '</AuraDefinitionBundle>\n';
    ...
    it('should generate correct file map for AuraDefinition event metadata', () => {
      ...
      expectedMetaXML += '    <apiVersion>48.0</apiVersion>\n';
      expectedMetaXML += '    <description>A bundle</description>\n';
      expectedMetaXML += '    <type>Event</type>\n';
      expectedMetaXML += '</AuraDefinitionBundle>\n';
    ...
    it('should generate correct file map for AuraDefinition interface metadata', () => {
      ...
      expectedMetaXML += '    <apiVersion>48.0</apiVersion>\n';
      expectedMetaXML += '    <description>A bundle</description>\n';
      expectedMetaXML += '    <type>Interface</type>\n';
      expectedMetaXML += '</AuraDefinitionBundle>\n';
    ...
    it('should generate correct file map for AuraDefinition tokens metadata', () => {
      ...
      expectedMetaXML += '    <apiVersion>48.0</apiVersion>\n';
      expectedMetaXML += '    <description>A bundle</description>\n';
      expectedMetaXML += '    <type>Tokens</type>\n';
      expectedMetaXML += '</AuraDefinitionBundle>\n';
